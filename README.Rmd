...
## Do not edit the .md version of the README, edit .Rmd only!!!
```
...
Sam Albers, Leonardo Collado-Torres, [Mauro Lepore](https://twitter.com/mauro_lepore), [Joyce Robbins](https://twitter.com/jtrnyc), Noam Ross, [Omayma Said](https://github.com/OmaymaS)
